...
from src.custom_agents.dr_tulu.search.search_utils import extract_snippet_with_context
...
class Document(BaseModel):
    ...
    def simple_stringify(self, prioritize_summary: bool = False) -> str:
        ...
        if (not prioritize_summary or not self.summary) and self.text:
    ...
    def stringify(
        ...
        elif use_localized_snippets and self.snippet:
