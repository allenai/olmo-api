...
from pydantic_ai.models import Model, download_item
from pydantic_ai.models.openai import OpenAIChatModel
from pydantic_ai.providers.openai import OpenAIProvider
from typing_extensions import Literal, Required, TypedDict, assert_never
...
def get_modal_openai_model(model_config: ModelConfig) -> Model:
    ...
    OpenAIChatModel._map_user_prompt = _map_user_prompt
