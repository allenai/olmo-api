...
from src.dao.message_respository import BaseMessageRepository
from src.message.message_service import get_message
from src.thread.thread_models import Thread


def get_thread(thread_id: str, message_repository: BaseMessageRepository, dbc: db.Client) -> Thread:
    config = get_config()
