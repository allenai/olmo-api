...
# Taken from https://github.com/pydantic/pydantic-ai/blob/9af531667fc2b5f87b8f61145f8b14f97217a62a/tests/mcp_server.py
...
async def echo_deps(ctx: Context[ServerSession, None]) -> dict[str, Any]:
    ...
    deps: Any = ctx.request_context.meta.deps  # type: ignore
