...
function(apiImage, cause, sha, env='prod', branch='', repo='', buildId='')
    ...
    local corsIngressAnno = {
        ...
        'nginx.ingress.kubernetes.io/cors-allow-origin': 'https://olmo.allen.ai,https://*.olmo.allen.ai,https://playground.allenai.org,https://*.playground.allenai.org,https://*.olmo-ui.allen.ai,https://olmo-ui-playground-test.allen.ai,http://localhost:8080',
        'nginx.ingress.kubernetes.io/cors-allow-credentials': 'true',
        'nginx.ingress.kubernetes.io/cors-allow-headers': 'X-Anonymous-User-Id'
    };
