...
) -> Optional[Union[HTTPValidationError, InfiniGramRankResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = InfiniGramRankResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, InfiniGramRankResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[HTTPValidationError, InfiniGramRankResponse]
    """
